...
const dataFlows = [
  {
    title: 'Audio Input Flow',
    subtitle: 'From user to server',
  ...
  },
  {
    ...
    subtitle: 'From server to user',
    icon: SpeakerWaveIcon,
    steps: [
      'Server returns audio data',
      'Decode audio data',
      'Audio playback'
    ]
  },
  {
    title: 'Control Command Flow',
    subtitle: 'Command processing and execution',
