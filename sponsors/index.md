...
description: Thank you to all sponsors for your support
sidebar: false
outline: deep
---
...
<div class="header-content">
  <h2>Thank you to all sponsors for your support ❤️</h2>
</div>
...
Please sponsor through the following methods:  
...
- Specify your device model in the sponsorship notes, and I will prioritize support for these devices
- Directly sponsor/donate hardware devices to help with development and compatibility testing
- Provide detailed parameters and usage scenarios of your device to assist in better development

::: tip Contact Information
For hardware sponsorship, please contact me via the email on my GitHub homepage to arrange shipping methods and address.
:::
