...
This page collects and showcases ecosystem projects related to py-xiaozhi, including:
...
- Installation and operation guides for various devices
- Integration solutions with smart home systems
- Tutorials for developing custom voice commands and skills
- Project cases built on py-xiaozhi
- Community-contributed extension features

## Contribute

If you have related projects or extensions to share, you are welcome to contribute in the following ways:

1. Submit a Pull Request on GitHub to add your project
2. Suggest integrations or extensions you’d like to see in Issues
3. Share your experiences and case studies using py-xiaozhi
